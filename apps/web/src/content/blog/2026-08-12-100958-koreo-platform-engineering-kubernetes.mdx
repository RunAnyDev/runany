...
- Project page: [koreo.dev](https://koreo.dev)
- Source repository: [github.com/koreo-dev](https://github.com/koreo-dev)
- License: [Apache-2.0](https://github.com/koreo-dev/koreo-core/blob/main/LICENSE)
