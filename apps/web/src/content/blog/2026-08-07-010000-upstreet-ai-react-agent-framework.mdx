...
- Project page: [upstreet.ai](https://upstreet.ai)
...
The core SDK is published as [`usdk`](https://www.npmjs.com/package/usdk) on npm. According to the project docs, the framework is built around a monorepo containing:
