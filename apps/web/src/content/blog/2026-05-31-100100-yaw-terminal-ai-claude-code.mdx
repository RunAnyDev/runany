...
description: "Yaw auto-splits your screen when you run Claude Code, Codex, or Gemini CLI — AI on the left, a shell in the same directory on the right. Terminal, connection manager, and AI chat in one app."
pubDate: "2026-05-31"
