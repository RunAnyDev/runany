...
- Project page: [aethene.dev](https://aethene.dev)
- Source repository: [github.com/Nuro-Labs/aethene](https://github.com/Nuro-Labs/aethene)
- License: [MIT](https://github.com/Nuro-Labs/aethene/blob/main/LICENSE)
...
**A:** Not currently. The the project docs show only a Convex + Docker self-hosting path. A standalone database adapter would need to be built.
