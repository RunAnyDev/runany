---
title: "What Is Mastra? TypeScript AI Agent Framework — Full Guide"
description: "Mastra is an open-source TypeScript framework for building AI agents. Learn how it handles workflows, memory, RAG, MCP integration, and local debugging for production apps."
pubDate: "2026-06-01"
...
Related reading: [TypeScript AI agent frameworks](/tags/typescript/), [Developer tools](/category/dev-tools/), [openmonoagent local docker coding agent](/blog/openmonoagent-ai-setup-guide-open-source-c-ai-tool/), and [kapso whatsapp api for developers](/blog/kapso-whatsapp-developers/).
