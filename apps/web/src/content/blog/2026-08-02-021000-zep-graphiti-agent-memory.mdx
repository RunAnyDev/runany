...
**A:** Any LLM with an OpenAI-compatible API interface. The the project docs show examples with Ollama (local), and the framework is designed to work with OpenAI, Anthropic, or other compatible providers.
