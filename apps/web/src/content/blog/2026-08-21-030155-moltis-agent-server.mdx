...
description: "Moltis is a secure, persistent personal agent server written in Rust. One binary, sandboxed execution, multi-provider LLMs, voice, memory, and built-in integrations for Telegram, Discord, Slack"
pubDate: "2026-08-21"
