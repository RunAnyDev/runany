...
**A:** According to the project docs, it dynamically selects from unlimited available tools while optimizing token usage — claiming up to 80 percent token reduction per query compared to naive function calling approaches.
