...
description: "Cicada replaces GitHub Actions and GitLab CI YAML configs with a custom functional DSL, letting you write pipelines using variables, functions, and shell commands."
pubDate: "2026-05-29"
