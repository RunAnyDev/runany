...
description: "A feature-rich terminal UI client for Discord written in Rust. Keyboard-driven navigation, markdown rendering, and low resource usage for developers who live in the terminal."
pubDate: "2026-06-01"
