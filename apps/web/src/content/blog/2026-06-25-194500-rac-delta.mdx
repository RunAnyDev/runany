...
The protocol is **backend agnostic** — it does not tie you to any specific cloud provider. The the project docs show an SSH adapter example, but the modular adapter system means you can plug in S3, Azure Blob Storage, signed URLs, or any custom backend.
