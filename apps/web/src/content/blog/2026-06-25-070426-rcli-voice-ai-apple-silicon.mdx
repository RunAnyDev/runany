...
The core differentiator is **MetalRT**, a proprietary GPU inference engine built specifically for Apple Silicon that accelerates both LLM decoding and speech processing on the Metal GPU. According to the project docs, MetalRT on M3 Max outperforms llama.cpp and Apple MLX on decode throughput.
