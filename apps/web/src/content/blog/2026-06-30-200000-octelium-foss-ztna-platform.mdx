---
title: "Octelium – FOSS Zero Trust Access Platform (ZTNA, VPN,"
...
- Project page: [octelium.com](https://octelium.com)
- Source repository: [github.com/octelium/octelium](https://github.com/octelium/octelium)
...
The installer sets up a single-node Kubernetes cluster with Octelium's control plane. The the project docs say a cheap cloud VM (DigitalOcean Droplet, Hetzner, AWS EC2, Vultr) is sufficient for most development and personal use cases.
