...
description: "Serve Sim is npx for Apple iOS simulators. Spawns simulators on demand with a single command, exposes them via HTTP for screenshots and interaction, and runs headlessly for AI agents and CI pipelines."
pubDate: "2026-06-02"
