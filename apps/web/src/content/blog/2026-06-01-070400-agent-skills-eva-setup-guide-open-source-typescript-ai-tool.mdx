...
description: "A test runner for agentskills.io-style AI agent skills. Validate skill behavior with YAML test specs, JSONL output, and OpenAI-compatible evaluation — ship."
pubDate: "2026-06-01"
