...
description: "DEEIX Chat packages model routing, multimodal chat, file handling, teams, OAuth, billing, and admin controls into one open-source AI workspace deployable with Docker or from source."
pubDate: "2026-06-09"
