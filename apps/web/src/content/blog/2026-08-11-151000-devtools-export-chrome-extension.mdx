...
- Project page: [devtoolsexport.com](https://devtoolsexport.com)
- Source repository: [github.com/mariusbolik/chrome-devtools-export](https://github.com/mariusbolik/chrome-devtools-export)
