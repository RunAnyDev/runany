...
description: "Harbor SDK packages TypeScript and Python clients, generated protocol types, and a local Harbor-compatible server for teams building tool-heavy agent systems." 
pubDate: "2026-06-08"
...
image:
  ...
  alt: "Harbor SDK GitHub tool guide thumbnail"
draft: false
---
...
That split is clean. A lot of SDK repos dump everything into one namespace and leave users to discover the stable parts by trial. Harbor SDK draws harder boundaries.
