...
**A:** The minimum stack is one Docker host with PostgreSQL and ClickHouse. The the project docs show Docker as the install path. A small VPS (2GB RAM) is sufficient for low-to-medium traffic sites.
