...
The integration grid in the the project docs show icons for 38 apps including Confluence, Jira, Notion, Salesforce, Slack, and Stripe. Each connector handles auth, rate limiting, and incremental updates independently.
