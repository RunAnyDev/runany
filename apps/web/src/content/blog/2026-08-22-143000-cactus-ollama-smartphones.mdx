...
The core differentiating claim is the **Cactus Graph** — a zero-copy computation graph that routes requests between on-device models and cloud handoff without re-encoding. According to the project docs, it handles text, speech, and vision through a unified API.
...
The the project docs show a C API example, but the CLI wraps this into a standard OpenAI-compatible HTTP interface.
