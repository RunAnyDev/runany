...
description: "Restate is an open-source durable execution runtime built in Rust, bringing low-latency workflow orchestration to JavaScript and Java with a lightweight single-binary deployment."
pubDate: "2026-06-02"
