---
title: "yao-open-prompts Setup Guide: Open Source Python AI Tool"
description: "yao-open-prompts setup guide based on the official GitHub README: learn what this open-source AI tool does, documented install steps, and usage notes."
pubDate: "2026-05-28"
...
> **TL;DR:** [yao-open-prompts](https://github.com/yaojingang/yao-open-prompts) is an emerging open-source developer tool with 2,310 stars; this guide follows the official README instead of guessing install steps.

## Source and Accuracy Notes

The README is available at [the official docs source](https://github.com/yaojingang/yao-open-prompts/blob/main/README.md), but it does not expose clear install or usage headings that can be extracted safely. This post avoids inventing commands and points you back to the repo docs.
...
yao-open-prompts is an open-source project hosted at [yaojingang/yao-open-prompts](https://github.com/yaojingang/yao-open-prompts). Repository summary: Yao Open Prompts：中文 AI 提示词库，覆盖工作、学习、内容、营销和生活场景

Repository signals at write time:

- Official GitHub repo: [yaojingang/yao-open-prompts](https://github.com/yaojingang/yao-open-prompts)
- README / docs source: [https://github.com/yaojingang/yao-open-prompts/blob/main/README.md](https://github.com/yaojingang/yao-open-prompts/blob/main/README.md)
- Stars: 2,310
- Forks: 355
- Open issues: 0
...
Use this checklist before adding yao-open-prompts to a real project:
...
**A:** The official repo is [yaojingang/yao-open-prompts](https://github.com/yaojingang/yao-open-prompts).
...
yao-open-prompts is worth evaluating only after reading the official README and running the documented setup path. Start with [yaojingang/yao-open-prompts](https://github.com/yaojingang/yao-open-prompts), compare the extracted commands above with current docs, and test in a safe environment before using it on production code or private data.
