...
- Project page: [skillscript.ai](https://skillscript.ai)
- Source repository: [github.com/sshwarts/skillscript](https://github.com/sshwarts/skillscript)
- License: [MIT](https://github.com/sshwarts/skillscript/blob/main/LICENSE)
