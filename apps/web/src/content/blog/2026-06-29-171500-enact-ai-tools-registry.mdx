...
- Project page: [enact.tools](https://enact.tools)
- Source repository: [github.com/EnactProtocol/enact](https://github.com/EnactProtocol/enact)
...
**A:** No. Enact has an MCP server package (`packages/mcp-server`) and can work alongside MCP clients. The the project docs show Enact sitting between the AI model/host and MCP or CLI tool calls as an enforcement layer.
