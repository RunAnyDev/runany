...
- Project page: [devtui.com](https://devtui.com)
- Source repository: [github.com/skatkov/devtui](https://github.com/skatkov/devtui)
- License: [MIT](https://github.com/skatkov/devtui/blob/main/LICENSE)
