...
description: "A secure persistent personal agent server written in Rust — sandboxed tool execution, multi-provider LLMs, voice I/O, SQLite plus vector memory, and built-in integrations for Telegram, Discord"
pubDate: "2026-09-03"
