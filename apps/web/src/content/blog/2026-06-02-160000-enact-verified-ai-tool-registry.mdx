...
description: "Browse, discover, and safely run AI tools with cryptographic verification. Enact is the npm for AI agents—a registry with end-to-end proofs that tools do exactly what they claim."
pubDate: "2026-06-02"
