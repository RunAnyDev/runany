...
description: "A browser extension that uses AI to let you modify any website using natural language commands — hide clutter, add features, re-theme pages, and automate."
pubDate: "2026-05-29"
