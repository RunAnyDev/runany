...
description: "Jibril uses eBPF to monitor and enforce security policies directly in the Linux kernel, protecting ephemeral cloud workloads in real time with negligible."
pubDate: "2026-05-31"
