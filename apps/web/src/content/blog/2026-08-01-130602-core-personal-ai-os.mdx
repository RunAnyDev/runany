...
- Project page: [getcore.me](https://getcore.me)
- Source repository: [github.com/RedPlanetHQ/core](https://github.com/RedPlanetHQ/core)
- License: [AGPL 3.0](https://github.com/RedPlanetHQ/core/blob/main/LICENSE)
