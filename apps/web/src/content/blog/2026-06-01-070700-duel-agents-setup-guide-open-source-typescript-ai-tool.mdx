...
description: "CLI, SDK, and IDE plugins for adversarial AI agent workflows. Pit two AI agents against each other — one builds, one critiques — for higher-quality code through structured debate."
pubDate: "2026-06-01"
