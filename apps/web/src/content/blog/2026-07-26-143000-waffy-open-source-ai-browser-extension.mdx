...
description: "Waffy is a free, open-source Chrome extension that automates web tasks using AI. Tell it what to do in plain English and it clicks, types, and scrolls through workflows for you. No backend, no"
pubDate: "2026-07-26"
