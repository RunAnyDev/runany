---
title: "What Is OpenMonoAgent.ai? Local Coding Agent with llama.cpp"
description: "OpenMonoAgent.ai is a local coding agent for .NET 10 with Dockerized llama.cpp, MCP support, sandboxed workspaces, sub-agents, hardware-aware model sizing, and optional vision."
pubDate: "2026-05-28"
