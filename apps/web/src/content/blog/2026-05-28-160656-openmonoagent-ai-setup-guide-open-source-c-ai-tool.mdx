---
title: "OpenMono (OpenMonoAgent) — Local Coding Agent with llama.cpp & MCP"
description: "OpenMono (also called OpenMonoAgent or openmonoagent.ai) is a .NET 10 local coding agent that wraps Dockerized llama.cpp with MCP support, sub-agents, and hardware-aware model sizing. No cloud."
pubDate: "2026-05-28"
