...
description: "Store files securely in cloud storage without trusting the host. Rust encrypted containers with passphrase, FIDO2 (YubiKey), TPM 2.0, and post-quantum ML-KEM keyslots."
pubDate: "2026-06-01"
