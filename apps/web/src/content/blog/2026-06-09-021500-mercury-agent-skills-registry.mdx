...
description: "Mercury Agent Skills collects reusable skill packs for Mercury Agent, OpenClaw, and Hermes so teams can add memory, workflows, and domain playbooks without rebuilding every prompt stack from scratch."
pubDate: "2026-06-09"
