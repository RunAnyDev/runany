...
The engine deliberately constrains what you can do — 320×180 default resolution, 16×16 sprite grid, a single `sprites.png` for all textures. These constraints are intentional: the the project docs say "You can't do everything, but you've got what you need to make a great 2D game."
