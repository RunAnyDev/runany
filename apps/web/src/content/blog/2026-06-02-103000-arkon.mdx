...
description: "Arkon compiles company docs into an AI knowledge wiki and serves it to Claude via MCP with role-based access control. Self-hosted with Docker with department-scoped knowledge and audit logging."
pubDate: "2026-06-02"
