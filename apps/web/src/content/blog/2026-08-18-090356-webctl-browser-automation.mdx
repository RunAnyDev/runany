...
description: "Browser automation CLI that flips the MCP model — instead of a server deciding what enters your context, you pipe CLI output through grep/jq/head. Benchmarks show 8.5/10 quality at $0.18/task vs"
pubDate: "2026-08-18"
...
**A:** Yes. The the project docs show human-readable output, grep filtering, and JSONL mode for scripting with jq.
