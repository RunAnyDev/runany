...
description: "Lukan is an open-source, sandboxed AI agent workstation that runs fully local. Built in Rust with 60ms cold start and a 32MB core, it handles code, email, calendar, and automation through a tmux-based terminal interface."
pubDate: "2026-06-15"
