...
description: "Perplexity's Bumblebee scans lockfiles, package metadata, MCP configs, and extensions on macOS and Linux to answer one incident-response question fast: where is vulnerable software present?"
pubDate: "2026-06-11"
...
- Related runany post: [/blog/enforceauth-authorization-ai-agent-era/](/blog/enforceauth-authorization-ai-agent-era/)
