...
description: "Terax AI is a 7MB terminal-first AI dev workspace built with Tauri and Rust. Bundles AI agents, code editing, and terminal into one cross-platform desktop app for macOS, Linux, and Windows."
pubDate: "2026-06-02"
