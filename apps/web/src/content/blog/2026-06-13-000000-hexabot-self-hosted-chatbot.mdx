...
description: "Hexabot is an open-source AI chatbot platform with a visual workflow builder, multi-channel support (web, WhatsApp, Discord), MCP tool integration, and full self-hosted deployment for teams that need data privacy and custom control."
pubDate: "2026-06-13"
