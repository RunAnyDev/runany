...
description: "Run a 13k-line Rust coding agent at 16MB RAM. Multi-provider, session management, permission system, MCP support, and integrated search — the leanest AI coding agent available."
pubDate: "2026-06-01"
