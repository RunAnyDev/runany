---
title: "Mocktail – Self-hosted mock API server with built-in"
description: "A free, open-source mock API server that runs as a single ~25 MB binary. Define endpoints, generate realistic data, inspect live traffic, and create mocks via AI or MCP — no signup, no cloud, runs"
pubDate: "2026-09-02"
