...
description: "RecipeUI is an open-source API client that uses TypeScript to statically type and autocomplete HTTP requests, catching errors before runtime. Built with Tauri, NextJS, and Supabase."
pubDate: "2026-05-31"
