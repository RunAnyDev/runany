...
Minimum host spec: **2 vCPU, 4 GB RAM** — the the project docs say this is the lowest stable spec, suitable for approximately 10 GB/day of ingest. The docs note that below this spec, ClickHouse and the API will OOM under load.
