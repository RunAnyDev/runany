...
description: "Butterbase OSS is an open-source backend-as-a-service with a built-in AI gateway. Postgres, auth, storage, edge functions — self-hostable with Docker Compose."
pubDate: "2026-06-02"
